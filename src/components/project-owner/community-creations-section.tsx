...
import CommunityCreationCard from '@/components/ui/community-creation-card';

import { communityCreationsSection } from '@/styles/community-creations-section';
...
export default function CommunityCreationsSection() {
	return (
		<Box component='section' sx={communityCreationsSection}>
			<h2>Content created</h2>
			<p>
				Create content related to this project, then post on social media with
				the hastag #projectName for it show up here. Then, vote on your favorite
				content to see it represented in the final project NFT!
			</p>
			<div className='grid'>
